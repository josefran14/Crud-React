...
import {
  ...
  useId_default
} from "./chunk-WPLXYXBS.js";
import {
  init_useEventCallback,
  init_useIsFocusVisible,
  useEventCallback_default,
  useIsFocusVisible_default
} from "./chunk-QUY7QGZG.js";
import {
  init_useForkRef,
  useForkRef_default
} from "./chunk-JZKI6PEG.js";
import {
  capitalize_default,
  init_capitalize
} from "./chunk-AO5SWV2G.js";
import {
...
var FormControlLabel = React62.forwardRef(function FormControlLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime71.jsxs)(FormControlLabelRoot, _extends({
    ...
    children: [React62.cloneElement(control, controlProps), label]
  }));
});
...
var FormLabel = React65.forwardRef(function FormLabel2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiFormLabel"
  });
...
var GridContext = React66.createContext();
if (true) {
...
var Grid = React67.forwardRef(function Grid2(inProps, ref) {
  ...
  const columnsContext = React67.useContext(GridContext_default);
...
function useMediaQueryOld(query, defaultMatches, matchMedia, ssrMatchMedia, noSsr) {
  const [match, setMatch] = React69.useState(() => {
    if (noSsr && matchMedia) {
...
var maybeReactUseSyncExternalStore = React69["useSyncExternalStore"];
function useMediaQueryNew(query, defaultMatches, matchMedia, ssrMatchMedia, noSsr) {
  const getDefaultSnapshot = React69.useCallback(() => defaultMatches, [defaultMatches]);
  const getServerSnapshot = React69.useMemo(() => {
    if (noSsr && matchMedia) {
      return () => matchMedia(query).matches;
    }
  ...
  const [getSnapshot, subscribe] = React69.useMemo(() => {
    if (matchMedia === null) {
      return [getDefaultSnapshot, () => () => {
      }];
    }
...
function HiddenJs(props) {
  ...
  return (0, import_jsx_runtime78.jsx)(React71.Fragment, {
    children
  });
}
...
var MobileStepper = React96.forwardRef(function MobileStepper2(inProps, ref) {
  ...
  return (0, import_jsx_runtime107.jsxs)(MobileStepperRoot, _extends({
    ...
    children: [backButton, variant === "text" && (0, import_jsx_runtime107.jsxs)(React96.Fragment, {
      ...
      children: [...new Array(steps)].map((_4, index) => (0, import_jsx_runtime108.jsx)(MobileStepperDot, {
...
var NativeSelect = React98.forwardRef(function NativeSelect2(inProps, ref) {
  ...
  return (0, import_jsx_runtime111.jsx)(React98.Fragment, {
...
var Select = React119.forwardRef(function Select2(inProps, ref) {
  ...
  return (0, import_jsx_runtime135.jsx)(React119.Fragment, {
...
function SliderValueLabel(props) {
  ...
  return React121.cloneElement(children, {
    className: clsx_m_default(children.props.className)
  }, (0, import_jsx_runtime138.jsxs)(React121.Fragment, {
...
true ? SliderValueLabel.propTypes = {
  children: import_prop_types93.default.element.isRequired,
  className: import_prop_types93.default.string,
  value: import_prop_types93.default.node
} : void 0;

// node_modules/@mui/material/Slider/Slider.js
var import_jsx_runtime139 = __toESM(require_jsx_runtime());
var import_jsx_runtime140 = __toESM(require_jsx_runtime());
var _excluded87 = ["aria-label", "aria-valuetext", "aria-labelledby", "component", "components", "componentsProps", "color", "classes", "className", "disableSwap", "disabled", "getAriaLabel", "getAriaValueText", "marks", "max", "min", "name", "onChange", "onChangeCommitted", "orientation", "size", "step", "scale", "slotProps", "slots", "tabIndex", "track", "value", "valueLabelDisplay", "valueLabelFormat"];
...
var Slider = React122.forwardRef(function Slider2(inputProps, ref) {
  ...
  return (0, import_jsx_runtime140.jsxs)(RootSlot, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime139.jsx)(RailSlot, _extends({}, railProps)), (0, import_jsx_runtime139.jsx)(TrackSlot, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min && mark.value <= max).map((mark, index) => {
      ...
      return (0, import_jsx_runtime140.jsxs)(React122.Fragment, {
      ...
      return (0, import_jsx_runtime139.jsx)(React122.Fragment, {
        children: (0, import_jsx_runtime139.jsx)(ValueLabelComponent, _extends({}, !isHostComponent_default(ValueLabelComponent) && {
          valueLabelFormat,
          valueLabelDisplay,
...
var SnackbarContent = React123.forwardRef(function SnackbarContent2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiSnackbarContent"
  });
...
var Snackbar = React124.forwardRef(function Snackbar2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiSnackbar"
  });
  ...
  const timerAutoHide = React124.useRef();
  const [exited, setExited] = React124.useState(true);
  ...
  const handleResume = React124.useCallback(() => {
  ...
  return (0, import_jsx_runtime143.jsx)(ClickAwayListener_default, _extends({
    ...
    children: (0, import_jsx_runtime143.jsx)(SnackbarRoot, _extends({
      className: clsx_m_default(classes.root, className),
      onBlur: handleBlur,
      onFocus: handleFocus,
...
var Zoom = React125.forwardRef(function Zoom2(props, ref) {
  const theme = useTheme();
  const defaultTimeout = {
    enter: theme.transitions.duration.enteringScreen,
    exit: theme.transitions.duration.leavingScreen
  ...
  return (0, import_jsx_runtime144.jsx)(TransitionComponent, _extends({
    ...
    children: (state, childProps) => {
      return React125.cloneElement(children, _extends({
        style: _extends({
          transform: "scale(0)",
          visibility: state === "exited" && !inProp ? "hidden" : void 0
...
var SpeedDial = React126.forwardRef(function SpeedDial2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiSpeedDial"
  });
  ...
  const eventTimer = React126.useRef();
  React126.useEffect(() => {
    return () => {
      clearTimeout(eventTimer.current);
    };
  }, []);
  const focusedAction = React126.useRef(0);
  const nextItemArrowKey = React126.useRef();
  const actions = React126.useRef([]);
  actions.current = [actions.current[0]];
  const handleOwnFabRef = React126.useCallback((fabFef) => {
  ...
  const allItems = React126.Children.toArray(childrenProp).filter((child) => {
    if (true) {
      if ((0, import_react_is9.isFragment)(child)) {
        console.error(["MUI: The SpeedDial component doesn't accept a Fragment as a child.", "Consider providing an array instead."].join("\n"));
      }
    }
    return React126.isValidElement(child);
  });
  ...
  return (0, import_jsx_runtime146.jsxs)(SpeedDialRoot, _extends({
    ...
    children: [(0, import_jsx_runtime145.jsx)(TransitionComponent, _extends({
      ...
      children: (0, import_jsx_runtime145.jsx)(SpeedDialFab, _extends({
        ...
        ref: handleFabRef,
        ownerState,
        children: React126.isValidElement(icon) && isMuiElement_default(icon, ["SpeedDialIcon"]) ? React126.cloneElement(icon, {
          open
        }) : icon
      }))
...
var Tooltip = React127.forwardRef(function Tooltip2(inProps, ref) {
  ...
  return (0, import_jsx_runtime148.jsxs)(React127.Fragment, {
    children: [React127.cloneElement(children, childrenProps), (0, import_jsx_runtime147.jsx)(PopperComponent, _extends({
...
var SpeedDialAction = React128.forwardRef(function SpeedDialAction2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiSpeedDialAction"
  });
  ...
  const [tooltipOpen, setTooltipOpen] = React128.useState(tooltipOpenProp);
...
var SpeedDialIcon = React130.forwardRef(function SpeedDialIcon2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiSpeedDialIcon"
  });
  ...
  function formatIcon(icon, newClassName) {
    if (React130.isValidElement(icon)) {
      return React130.cloneElement(icon, {
...
function joinChildren(children, separator) {
  ...
  return childrenArray.reduce((output, child, index) => {
    ...
    if (index < childrenArray.length - 1) {
      output.push(React131.cloneElement(separator, {
        key: `separator-${index}`
      }));
    }
    return output;
...
var Stack = React131.forwardRef(function Stack2(inProps, ref) {
  const themeProps = useThemeProps2({
    props: inProps,
    name: "MuiStack"
  });
  ...
  return (0, import_jsx_runtime154.jsx)(StackRoot, _extends({
    as: component,
    ownerState,
    ref
  }, other, {
...
var Step = React134.forwardRef(function Step2(inProps, ref) {
  ...
  return (0, import_jsx_runtime156.jsx)(StepContext_default.Provider, {
    value: contextValue,
    children: connector && !alternativeLabel && index !== 0 ? (0, import_jsx_runtime155.jsxs)(React134.Fragment, {
...
var StepLabel = React138.forwardRef(function StepLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime162.jsxs)(StepLabelRoot, _extends({
    ...
    children: [icon || StepIconComponent ? (0, import_jsx_runtime161.jsx)(StepLabelIconContainer, {
      ...
      ownerState,
      children: [children ? (0, import_jsx_runtime161.jsx)(StepLabelLabel, _extends({
        ownerState
      }, labelSlotProps, {
...
var StepButton = React139.forwardRef(function StepButton2(inProps, ref) {
  ...
  const child = isMuiElement_default(children, ["StepLabel"]) ? React139.cloneElement(children, childProps) : (0, import_jsx_runtime163.jsx)(StepLabel_default, _extends({}, childProps, {
    children
  }));
...
var SwipeableDrawer = React144.forwardRef(function SwipeableDrawer2(inProps, ref) {
  ...
  return (0, import_jsx_runtime169.jsxs)(React144.Fragment, {
...
true ? SwipeableDrawer.propTypes = {
  allowSwipeInChildren: import_prop_types111.default.oneOfType([import_prop_types111.default.bool, import_prop_types111.default.func]),
...
var Tab = React146.forwardRef(function Tab2(inProps, ref) {
  ...
  return (0, import_jsx_runtime172.jsxs)(TabRoot, _extends({
    ...
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime172.jsxs)(React146.Fragment, {
      children: [icon, label]
    }) : (0, import_jsx_runtime172.jsxs)(React146.Fragment, {
      children: [label, icon]
    }), indicator]
  }));
});
...
var _excluded107 = ["className", "component", "padding", "size", "stickyHeader"];
...
var _excluded109 = ["align", "className", "component", "padding", "scope", "size", "sortDirection", "variant"];
...
var _excluded113 = ["className", "component", "disableGutters", "variant"];
...
var TableSortLabel = React162.forwardRef(function TableSortLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime189.jsxs)(TableSortLabelRoot, _extends({
    ...
    children: [children, hideSortIcon && !active ? null : (0, import_jsx_runtime188.jsx)(TableSortLabelIcon, {
      as: IconComponent,
